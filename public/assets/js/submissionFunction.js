    ...
    $(function() {
        $('#abstractSubmissionForm').validate({
            ...
            messages: {
                ...
                basic_science_format: "Type of abstract.",
                ...
                study_design: "Please describe the background.",
                introduction: "Please write the references.",
                methods: "Please explain the methods used.",
                results: "Please summarize the results.",
                conclusions: "Please provide the conclusions.",
                "primary_topic[]": "Please select primary topic",
                "secondary_topic[]": "Please select secondary topic",
                diversity: "Please select Inclusion and Equity Award",
                award_information: "Please select Abstract Award",
            },

...
<header style="margin-bottom: 130px;">
	...
	<div class="heroe">
		...
		<h1>Welcome to Abstract Suite</h1>

		<h2>An abstract and event management tool with powerful features</h2>
...
<footer>
	...
	<div class="copyrights">
		...
		<p>&copy; <?= date('Y') ?> &copy; One World. All rights reserved.</p>

...
<!--                </li>-->
            ...
            <ul class="navbar-nav mb-2 mb-md-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="<?=base_url()?>/acceptance/abstract_list">
                        <button type="button" class="btn btn-outline-light">My Meeting Activity <i class="fa-solid fa-briefcase"></i></button>
                    </a>
                </li>
                <?php endif;?>
                <!-- <li class="nav-item">
...
<script>
    $(function(){
        ...
        $('#logoutBtn').on('click', function(e){
            e.preventDefault();
            window.location.href = base_url+'/acceptance/logout';
        })
    })

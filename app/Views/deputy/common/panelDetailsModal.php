    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Panel Details</h5>
                    ...
                    <div class="collapse show" id="collapseGeneral">
                        <div class="card-body">
                            <table class="table">
                                <tbody>
                                <tr>
                                    <td style="width:200px" class="text-end fw-bolder">Submission ID : </td>
                                    <td id="paper-id"></td>
                                </tr>
                                <tr>
                                    <td class="text-end fw-bolder">Paper Title : </td>
                                    <td id="paper-title"></td>
                                </tr>
                                <tr>
                                    <td class="text-end fw-bolder" style="width:200px">Division : </td>
                                    <td id="division"></td>
                                </tr>
                                <tr>
                                    <td class="text-end fw-bolder">Paper Type : </td>
                                    <td id="paper-type">Panel</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="text-end fw-bolder">Interest in IJMC : </td>
...
<!--               Uploaded Files-->
                ...
                <div class="author-info card shadow">
                    <div class="card-header fw-bold" data-bs-toggle="collapse" data-bs-target="#collapseAuthorInfo" aria-expanded="true" aria-controls="collapseAuthorInfo">
                        Coordinators Information <i class="fas fa-chevron-down float-end"></i>
                    </div>
                ...
                <!-- Author Information -->
                <div class="panelist-info card shadow">
                    <div class="card-header fw-bold" data-bs-toggle="collapse" data-bs-target="#collapsePanelInfo" aria-expanded="true" aria-controls="collapsePanelInfo">
                        Panelist Information <i class="fas fa-chevron-down float-end"></i>
                    </div>
                    <div class="collapse show" id="collapsePanelInfo">
                        <div class="card-body p-0">
                            <div class="panelist-info-body" id="panelist-info-body">

                            </div>
<!--                            <table class="table">-->
<!--                                <tbody id="panelist-info-body"></tbody>-->
<!--                            </table>-->
                        </div>
                    </div>
                </div>

                ...
                <li class="nav-item dropdown mt-2">
                    <div class="btn-group">
                        <button type="button" class="btn btn-outline-light dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                            Program Chair Options <i class="fa-solid fa-briefcase"></i>
                        </button>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?=base_url()?>/deputy/papers_list">Paper Review Management</a></li>
                            <li><a class="dropdown-item" href="<?=base_url()?>/deputy/panels_list">Panel Review Management</a></li>
                            <li><a class="dropdown-item" href="<?=base_url()?>/deputy/reviewers_and_progress">Reviewers & Progress</a></li>
<!--                            <li><a class="dropdown-item" href="--><?php //=base_url()?><!--/deputy/panels_list">Review and Progress</a></li>-->
...
<div class="row mt-5">
    <div class="col-md-12 text-center mt-md-4" style="width: 70% !important; margin:auto">
...
<script>
    $(function(){
        ...
        $('#logoutBtn').on('click', function(e){
            ...
            e.preventDefault();
            window.location.href = base_url+'deputy/logout';
        })
    })

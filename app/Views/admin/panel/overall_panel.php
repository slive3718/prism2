...
<main style="padding-bottom:100px">
    <div class="container pb-5">
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <a href="<?=base_url()?>/admin/edit_panel_submission/<?=$panel_details['id']?>" class="btn btn-sm btn-primary float-end"><i class="fas fa-edit"></i> Edit</a>
                <table class="table">
                    <tbody>
                    <tr>
            ...
            <div class="card shadow">
                ...
                <div id="file-upload-body" class="collapse show" aria-labelledby="file-upload-header" data-bs-parent="#accordionExample">
                    <div class="card-body">
                        <a href="<?=base_url()?>/admin/presentation_upload/<?=$paper_id?>" class="btn btn-sm btn-primary float-end"><i class="fas fa-edit"></i> Edit</a>
            ...
            <div class="card shadow">
                ...
                <div id="paper-info-body" class="collapse show" aria-labelledby="paper-info-header" data-bs-parent="#accordionExample">
                    <div class="card-body">
                        <a href="<?=base_url()?>/user/panel_submission/<?=$paper_id?>" class="btn btn-sm btn-primary float-end"><i class="fas fa-edit"></i> Edit</a>

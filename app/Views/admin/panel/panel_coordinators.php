...
<script  type="text/javascript" src="<?=base_url('assets/js/admin/panelSubmissionFunctions.js?v=6')?>"></script>
<script  type="text/javascript" src="<?=base_url('assets/js/admin/locationAutocomplete.js')?>"></script>

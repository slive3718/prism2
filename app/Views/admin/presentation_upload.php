...
<!--                  Fill with ajax-->
            ...
            <div class="my-4">
                ...
                <button class="btn btn-primary btn-sm uploadFileBtn" paper_id="<?=$paper_id?>">Upload File</button>
...
<script>
    ...
    //
       $('.uploadFileBtn').on('click', function(){
        ...
        $('.presentationContinueBtn').on('click', function(){
            let paper_id= $('.uploadFileBtn').attr('paper_id')
    ...
    function getPaperUploads(){
        let paper_id= $('.uploadFileBtn').attr('paper_id')
       $.ajax({
           url : "<?=base_url('admin/get_paper_uploads')?>",
           type: 'POST',
           data: {
               'paper_id': paper_id
           },
